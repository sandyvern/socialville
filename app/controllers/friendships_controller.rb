class FriendshipsController < ApplicationController # :nodoc:
  ...
  before_action :set_friendship, %i( destroy accept ) # only: [:destroy, :accept]
  ...
  def accept
    ...
    #   owner: @friendship.user, recipient: @friendship.friend
    # # @friendship.create_activity key: 'friendship.accepted',
    #   owner: @friendship.friend, recipient: @friendship.user
    respond_to do |format|
